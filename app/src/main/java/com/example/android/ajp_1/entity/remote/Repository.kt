...
class Repository(
    ...
    companion object{
        ...
        fun getInstance(apiCall: ApiCall, localDataSource: LocalDataSource, appExecutors: AppExecutors): Repository =
            instance?: synchronized(this){
                instance?: Repository(apiCall, localDataSource, appExecutors)
            }
    }
